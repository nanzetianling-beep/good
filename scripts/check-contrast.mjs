...
const PAIRS = [
  ...
  { fg: 'color.semantic.accent.text',       bg: 'color.semantic.background.default', min: 4.5, use: 'アイブロウ等の小ラベル(差し色)' },
  { fg: 'color.semantic.accent.default',    bg: 'color.semantic.background.default', min: 3.0, use: '装飾・ヘアライン(差し色)' },
  { fg: 'color.semantic.text.on-inverse',   bg: 'color.semantic.background.inverse', min: 4.5, use: '深緑セクション上の本文' },
