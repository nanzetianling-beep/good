...
| [`claude-code-setup`](skills/claude-code-setup/SKILL.md) | Setup consultant — inspects a project and recommends the best approach across MCP, Skill, Hook, Agent, and Command, with concrete file locations. |
| [`skill-creator`](skills/skill-creator/SKILL.md) | Scaffolds and refines new skills: interview → valid `SKILL.md` → reference files → quality-evaluation-and-revision loop. |
...
| [`claude-md-management`](skills/claude-md-management/SKILL.md) | Create, audit, and optimize `CLAUDE.md` memory files (project, user, org) and `@imports`; prune bloat and contradictions. |
